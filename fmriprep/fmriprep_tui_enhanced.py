#!/usr/bin/env python3
"""
fmriprep_tui_enhanced.py - Enhanced Terminal User Interface for fMRIPrep Launcher

An improved browser-free, terminal-based GUI with better organization and widgets.

Requirements:
    pip install textual

Usage:
    python fmriprep_tui_enhanced.py
"""
...
from textual.widgets import (
    ...
    DataTable, TabbedContent, TabPane, DirectoryTree, ListView, ListItem,
    ProgressBar, Markdown, Rule
)
...
class FMRIPrepEnhancedTUI(App):
    """Enhanced Terminal UI for fMRIPrep Launcher"""
    ...
    def _compose_processing_tab(self) -> ComposeResult:
        ...
        with ScrollableContainer():
            ...
            yield Static("Use 'auto' to find latest, or specify path", classes="help-text")
    ...
    def detect_containers(self) -> None:
        ...
        if runtime == "singularity":
            ...
            if containers:
                ...
                container_input = self.query_one("#container", Input)
